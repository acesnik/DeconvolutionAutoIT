...
;                       off somehow
;           ?????? v0.8 
;           150115 v0.8 Didn't change version; merely set line171 sleep to 200 from 500
;                       so that runs with lots of "No Deconv. Result" won't take so long.
;                       Tried 100ms but that led to occassional errors.---BLF
;
